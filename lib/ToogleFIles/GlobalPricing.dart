...
class GlobalPricing extends StatelessWidget {
  const GlobalPricing({Key? key}) : super(key: key);
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              _buildDescription(
                text:
                    'This section can be used to set global product pricing rules for all your products.',
              ),
              const SizedBox(height: 20),
              const ProductItem(
                labelText: 'Products Cost',
                dropdownItems: ['TRY', 'Out'],
              ),
              const SizedBox(height: 20),
              const ProductItem(
                labelText: 'Compare Cost',
                dropdownItems: ['TRY', 'Out'],
              ),
              const SizedBox(height: 20),
              _buildDescription(
...
class _ProductItemState extends State<ProductItem> {
  ...
  String multiplierValue = 'MULTIPLIER';
    ...
    return Row(
      children: [
        Container(
          ...
          child: Image.network(
            'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ5eJQLdCC5MBMsFg4s5222_Eb7afPd4fW8Pw&usqp=CAU',
            fit: BoxFit.cover,
          ),
        ),
